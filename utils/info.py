...
def information(args):
    info = []
    info.append('======================================')
    info.append(f'    q(non-iid): {args.q}')
    info.append(f'    min_samples: {args.min_samples}')
    info.append(f'    min_cluster_size: {args.min_cluster_size}')
    ...
    if args.defence == 'RLR':
    ...
    elif args.defence == 'flame' or args.defence == 'fedmm':
        ...
        if args.turn != 0:
            ...
            if args.defence == 'fedmm':
                if (args.tp+args.fp) != 0:
                    info.append('TPR:'+str(args.tp/(args.tp+args.fp)))
                if (args.tn+args.fn) != 0:    
                    info.append('TNR:'+str(args.tn/(args.tn+args.fn)))
