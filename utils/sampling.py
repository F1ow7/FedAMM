...
def fmnist_noniid(dataset_label, num_clients, num_classes, q):
    proportion = non_iid_distribution_group(dataset_label, num_clients, num_classes, q)
    dict_users = non_iid_distribution_client(proportion, num_clients, num_classes)
    #  output clients' labels information
    # check_data_each_client(dataset_label, dict_users, num_clients, num_classes)
...
if __name__ == '__main__':
    ...
    # num = 100
    # d = cifar_noniid(dataset_train, num,10,0.2)
    # np.save('../data/non_iid_0.2_cifar.npy',d)
    # print(type(d))

    # trans_fmnist = transforms.Compose([transforms.ToTensor(), transforms.Normalize(mean=[0.2860], std=[0.3530])])
    # dataset_train=datasets.FashionMNIST('../../data/',train=True, download=True, transform=trans_fmnist)
    # num = 100
    # d = cifar_noniid(dataset_train, num,10,0.9)
    # np.save('../data/non_iid_0.9_fashion_mnist.npy',d)
    # print(type(d))
    ...
    num = 100
    d = cifar_noniid(dataset_train, num,10,0.1)
    np.save('../data/iid_mnist.npy',d)
    print(type(d))    
